...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val exampleBooking = Booking("Tennis", "Court 2", "25/05/2025", "9:00", true, exampleProfile)
        val exampleBooking2 = Booking("Tennis", "Court 1", "26/05/2025", "12:00", true, exampleProfile)
        val exampleBooking3 = Booking("Tennis", "Court 3", "27/05/2025", "15:00", true, exampleProfile)
        val exampleBooking4 = Booking("Padel", "Court 1", "27/05/2025", "15:00", true, exampleProfile)
        val exampleBooking5 = Booking("Padel", "Court 2", "28/05/2025", "10:00", true, exampleProfile)
